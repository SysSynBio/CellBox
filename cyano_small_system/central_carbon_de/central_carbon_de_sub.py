...
node = '1'
core = "1" 
out = "central_carbon_de_out"
err = "central_carbon_de_err"
...
for dispatch in range(dispatch_num):
    ...
    slurm += "max=" + str((dispatch + 1) * loop_num - 1) + "\nfor i in `seq " + str(dispatch * loop_num) + " $max`\ndo\n    python scripts/main.py -config=cyano_small_system/central_carbon_de/central_carbon_de.json -i=$i\ndone\n"
