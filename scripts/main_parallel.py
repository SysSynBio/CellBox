...
# parser.add_argument('-drug', '--drug_index', default=None, type=int)
parser.add_argument('-nodes', '--nodes_number', default=1, type=int)
parser.add_argument('-runs', '--runs_number', default=1, type=int)
...
def run_cellbox(master_args_list):
    working_index = master_args_list[0]
    cfg = cellbox.config.Config(master_args_list[1])
...
if __name__ == '__main__':
    ...
    number_of_nodes = master_args.nodes_number
